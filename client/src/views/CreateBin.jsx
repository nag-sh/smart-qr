...
export default function CreateBin({ qrId, onNavigate, onPrintBin }) {
  ...
  if (flowMode === 'choice') {
    return (
      <div className="w-full max-w-md mx-auto py-6 px-4 space-y-6">
        ...
        <div className="glass-panel rounded-3xl p-6 shadow-2xl relative overflow-hidden space-y-6">
  ...
  if (successBin && generatedQrText) {
    return (
      <div className="w-full max-w-md mx-auto py-6 px-4 space-y-6">
        <div className="glass-panel rounded-3xl p-6 shadow-2xl relative overflow-hidden text-center space-y-6">
          {/* Confetti-like glow */}
          ...
          <div className="space-y-3 text-left">
            <div className="bg-slate-900/60 p-4 rounded-xl border border-slate-800/80 space-y-2 text-xs">
              <div className="flex justify-between border-b border-slate-800/60 pb-1.5">
                ...
                <span className="text-slate-200 font-bold">{successBin.name}</span>
              </div>
              <div className="flex justify-between border-b border-slate-800/60 pb-1.5">
                <span className="text-slate-400 font-semibold">Location</span>
                <span className="text-slate-200">{successBin.location}</span>
              </div>
              <div className="space-y-1">
    ...
    <div className="w-full max-w-md mx-auto py-6 px-4">
      ...
      <div className="glass-panel rounded-3xl overflow-hidden shadow-2xl relative">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <button
            type="submit"
            disabled={loading || compressing || !name.trim() || !location.trim()}
